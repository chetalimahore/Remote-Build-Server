...
namespace MessagePassingComm
{
    ...
    {
        //public static string fileStorage { get; set; } = "../../../Repository/RepoStorage/All_Files/";
        public static string fileStorage { get; set; } = null;
    ...
    {
        //public static string fileStorage = "../../../ChildBuild/ChildStorage/";
        public static string fileStorage { get; set; } = null;
        public static string baseAddress { get; set; }
    }
    ...
    public interface IMessagePassingComm
    {
        ...
        [OperationContract]
        bool openFileForWrite(string name, string dest);
